defmodule ReportsGeneratorTest do
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when the options is 'foods', returns the food who spent the most" do
      file_name = "report_test.csv"
    ...
    test "when the options is invalid, returns an error" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("wrong")

      expected_response = {:error, "Invalid option! It has to be 'foods' or 'users'"}
